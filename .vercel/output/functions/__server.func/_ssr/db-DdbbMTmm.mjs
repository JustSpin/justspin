...
//#region node_modules/.nitro/vite/services/ssr/assets/db-DdbbMTmm.js
/**
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { requireUserId } = await import("./verify.server-DdkD25VQ.mjs");
...
async function loadPgliteAssets() {
	try {
		...
		const dirs = [join(process.cwd(), "node_modules/@electric-sql/pglite/dist"), join(process.cwd(), ".vercel/output/functions/__server.func/_libs")];
		for (const dir of dirs) {
			...
			return {
				...
				initdbWasmModule: initdb ? await WebAssembly.compile(initdb) : void 0,
